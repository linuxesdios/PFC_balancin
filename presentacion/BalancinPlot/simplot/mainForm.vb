...
Public Class mainForm
            ...
            Try
                ...
                Else
                    ...
                    If RadioButton2.Checked Then
                        TxtPID = "$" + "3,0,0,0," + TxtBox_Bias1.Text + "," + TxtBox_Bias2.Text + "," + TxtBox_comp.Text + "," + TxtBox_Q_angle.Text + "," + TxtBox_Q_bias.Text + "," + TxtBox_R_measure.Text + "," + TxtBox_Ts.Text + "," + TxtBox_filter.Text + "," + tipo_filtro_.ToString
                    End If
    ...
    Private Sub RadioButton2_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton2.CheckedChanged
        If sender.checked() Then
            TxtBox_Kd.Visible = False
            TxtBox_Ki.Visible = False
            TxtBox_Kp.Visible = False
    ...
    Private Sub RadioBoton1_CheckedChanged(sender As Object, e As EventArgs) Handles RadioBoton1.CheckedChanged
        If sender.checked() Then
            TxtBox_Kd.Visible = True
            TxtBox_Ki.Visible = True
            TxtBox_Kp.Visible = True
            Label9.Visible = True
            Label7.Visible = True
            Label6.Visible = True
        End If
